...
function SpectrumUI:CreateWindow(config)
    ...
    function Window:CreateTab(tabConfig)
        ...
        TabIcon.Image = "rbxassetid://7733771961" -- Icone de click padrão Roblox
        ...
        function Tab:Button(btnConfig)
            ...
            -- Icone de clique no botão
            local BtnIcon = Instance.new("ImageLabel")
            BtnIcon.Size = UDim2.new(0, 20, 0, 20)
            BtnIcon.Position = UDim2.new(0, 8, 0.5, -10)
            BtnIcon.BackgroundTransparency = 1
            BtnIcon.Image = "rbxassetid://7733771961"
            BtnIcon.Parent = ButtonFrame

            local ButtonLabel = Instance.new("TextLabel")
            ButtonLabel.Size = UDim2.new(1, -36, 1, 0)
            ButtonLabel.Position = UDim2.new(0, 32, 0, 0)
        ...
        function Tab:Dropdown(dropConfig)
            ...
            Arrow.Image = "rbxassetid://3926305904" -- Setinha para dropdown
            ...
            for _, option in pairs(dropConfig.Options or {}) do
                ...
                OptionButton.MouseButton1Click:Connect(function()
                    ...
                    if typeof(dropConfig.Callback) == "function" then
